...
public interface ToDoApi {
    @GetMapping("/todos")
    ResponseEntity<List<Task>> getToDos(@RequestParam int offset, int limit, String priority, String state, String name); //limit: number of records --- offset: first id to return
